...
+ (nonnull NSString *)REWARDED;
+ (nonnull NSString *)INTERSTITIAL;
 ...
 * This API will automatically locate the top view controller on the UIWindow.keyWindow to present the Ad from.
 * You can supply a UIViewController for the ad to present from by calling showAdFromViewController:
 */
- (void)showAd __attribute__((deprecated("Please use showAdFromViewController: to provide a UIViewController for the ad to present from.", "showAdFromViewController:")))
;
